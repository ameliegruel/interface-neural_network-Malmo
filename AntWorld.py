...
class AutonomousAgent():
    ...
    def __init__(
        ...
        connection_weight = connection_weight.scatter_(1, torch.tensor([np.random.choice(self.PN.n, size=10, replace=False) for i in range(self.KC.n)]).long(), PN_KC_weight)
